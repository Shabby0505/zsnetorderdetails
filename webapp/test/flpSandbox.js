		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Order Details",
									"targetURL": "#zsnetorderdetails-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zsnetorderdetails-display": {
								"semanticObject": "zsnetorderdetails",
								"action": "display",
								"description": "Order Details for Return",
								"title": "Order Details",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zsnetorderdetails",
									"url": sap.ui.require.toUrl("zsnetorderdetails")
								}
							}
						}
					}
